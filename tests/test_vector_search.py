...
# -- Unit tests: generate_embedding ----------------------------------------


class TestGenerateEmbedding:
    """Tests for the litellm-backed embedding generation helper."""

    async def test_returns_embedding_vector(self) -> None:
        """generate_embedding returns a float list from the provider."""
    ...
    async def test_custom_model_and_dimensions(self) -> None:
        ...
        with patch(
            ...
            result = await generate_embedding(
                "test", model="custom-model", dimensions=768
            )
...
async def vector_env(
    ...
    # Active item with embedding close to query
    ...
    # Active item with embedding far from query
    ...
    # Deprecated item with embedding close to query
